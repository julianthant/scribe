...
class SecureCredentialManager:
    ...
    def _store_token_in_key_vault(self, token_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.info("✅ OAuth token stored securely in Azure Blob Storage")
            return True
            
        except Exception as e:
            logger.error(f"❌ Failed to store token in Blob Storage: {e}")
            return False
    ...
    def _retrieve_token_from_key_vault(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if secret and secret.value:
                ...
                logger.info("✅ OAuth token retrieved securely from Azure Blob Storage")
                return token_data
            else:
            ...
            logger.error(f"❌ Failed to retrieve token from Blob Storage: {e}")
            return None
